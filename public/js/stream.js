...
function startRecording() {
    ...
    $('#stop-recording').show();
    $('#download-recording').attr('disabled', true);
    $('#upload-recording').attr('disabled', true);
    recordedBlobs = [];
...
function stopRecording() {
    ...
    $('#stop-recording').hide();
    $('#download-recording').attr('disabled', false);
    $('#upload-recording').attr('disabled', false);
    mediaRecorder.stop();
}
